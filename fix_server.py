...
class MyApplication(fix.Application):
    ...
    def onLogout(self, sessionID):
        ...
        # Check if the session is logged on before trying to get its state
        if fix.Session.lookupSession(sessionID).isLoggedOn():
            print(f"Session Status: Logged On")
        else:
            print(f"Session Status: Not Logged On")
...
def main():
    try:
        ...
        settings = fix.SessionSettings("/home/katana/Kanairo/Python&ML/fix_server.cfg")
