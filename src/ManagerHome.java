...
public class ManagerHome extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("ADD STAFF MEMBER");
        ...
        jTabbedPane1.addTab("ADD A STAFF MEMBER", jPanel2);
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ORDER ID", "ORDER AMOUNT", "DATE OF ORDER", "PAYMENT PLAN", "TOTAL COST"
            }
        ));
        ...
        jTabbedPane1.addTab("CHECK ORDER INVOICES ", jPanel3);

        jLabel6.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jLabel6.setText("DELETE STAFF");

        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder("SEARCH STAFF"));

        jLabel7.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel7.setText("ENTER A CORRECT STAFF ID AND CLICK");

        jLabel8.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel8.setText("THE SEARCH BUTTON TO VIEW AND DELETE");

        jLabel9.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel9.setText("A STAFF MEMBER.");
                        ...
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                .addGroup(jPanel5Layout.createSequentialGroup()
                                    ...
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                    .addComponent(staffid, javax.swing.GroupLayout.PREFERRED_SIZE, 174, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel6.setBorder(javax.swing.BorderFactory.createTitledBorder("DELETE STAFF"));
        ...
        staffid1.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        ...
        jPanel6Layout.setVerticalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(staffid1, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(32, 32, 32)
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        jTabbedPane1.addTab("DELETE STAFF MEMBER", jPanel4);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            if (rs.next()) {
                staffid1.setText(rs.getString("staffid"));
                password.setText(rs.getString("password"));
                
            } else {
                JOptionPane.showMessageDialog(null, "THERE IS NO STAFF WITH THAT ID!");
            }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try{
            ...
            String sql = "insert into staff (staffid,password)values('" + STAFFID + "','" + PASSWORD + "')";
            stmt.executeUpdate(sql);
           ...
           stmt=conn.prepareStatement(sql);
            rs=stmt.executeQuery(sql);
             ...
             Object rowData[]=new Object[5];
              while(rs.next()){
                rowData[0]=rs.getString("orderid");
                rowData[1]=rs.getString("orderamount");
                rowData[2]=rs.getString("dateoforder");
                rowData[3]=rs.getString("paymentplan");
                rowData[4]=rs.getString("costoforder");
